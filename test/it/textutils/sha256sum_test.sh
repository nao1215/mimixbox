export TEST_DIR=${MIMIXBOX_IT_ROOT}/sha256sum
...
Setup() {
    ...
    echo "5f2864b5833190b07b0b95228682ff5ec43a13a2a3f31514c57d5c92aa3fb2e7  ${MIMIXBOX_IT_ROOT}/sha256sum/1.txt" > ${CHECK_SUM_FILE}
    echo "833d8136112b60552a0f83165a2ebffeac4b0c0249480d651ea58b9073ec925b  ${MIMIXBOX_IT_ROOT}/sha256sum/2.txt" >> ${CHECK_SUM_FILE}
    echo "8e774f75a5a23c83e6f7d5e92863a2615e0335e06aec18d9c3ec1c5315d1a777  ${MIMIXBOX_IT_ROOT}/sha256sum/3.txt" >> ${CHECK_SUM_FILE}
}
